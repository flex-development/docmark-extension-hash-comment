...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/docmark-extension-yaml
   cd docmark-extension-yaml
   ```
...
```sh
https://github.com/flex-development/docmark-extension-yaml/compare/main...$branch
```
