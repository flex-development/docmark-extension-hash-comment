...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/docmark-extension-hash-comment
   cd docmark-extension-hash-comment
   ```
...
```sh
https://github.com/flex-development/docmark-extension-hash-comment/compare/main...$branch
```
